...
namespace BCM.Models
{
  ...
  public class BCMBiome : BCMAbstract
  {
    ...
    [UsedImplicitly] public int Rad;
    [UsedImplicitly] public string Spec;
    [UsedImplicitly] public int Depth;
    [NotNull] [UsedImplicitly] public Dictionary<string, string> Replacements = new Dictionary<string, string>();
    ...
    [NotNull] [UsedImplicitly] public List<BCMSubBiome> SubBiomes = new List<BCMSubBiome>();
    #endregion;
