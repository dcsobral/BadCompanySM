...
namespace BCM.Models
{
  ...
  public class BCMEntity : BCMAbstract
  {
    ...
    [UsedImplicitly] public double? Lifetime;
    [UsedImplicitly] public bool IsAlive;
    [UsedImplicitly] public double CreationTime;

    [UsedImplicitly] public int MaxHealth;
    [UsedImplicitly] public int Health;
    [UsedImplicitly] public bool IsScout;
    [UsedImplicitly] public bool IsFeral;
    [UsedImplicitly] public bool IsSleeper;
    [UsedImplicitly] public bool IsDecoy;
    [UsedImplicitly] public bool IsSleeping;

    [UsedImplicitly] public double SpeedModifier;
    [UsedImplicitly] public double SpeedDay;
    [UsedImplicitly] public double SpeedNight;
    #endregion;
