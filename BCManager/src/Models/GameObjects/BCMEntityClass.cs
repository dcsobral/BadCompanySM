...
namespace BCM.Models
{
  ...
  public class BCMEntityClass : BCMAbstract
  {
    ...
    [UsedImplicitly] public bool CanSpawn;
    [UsedImplicitly] public string Class;
    [UsedImplicitly] public string Model;
    [UsedImplicitly] public string Archetype;
    [UsedImplicitly] public int Experience;
    [UsedImplicitly] public int MaxHealth;
    [UsedImplicitly] public int DeadHP;
    [UsedImplicitly] public string HandItem;
    [UsedImplicitly] public int LootListOnDeath;
    [UsedImplicitly] public int LootListAlive;
    [UsedImplicitly] public bool IsEnemy;
    [UsedImplicitly] public int WalkType;
    [UsedImplicitly] public bool RotateToGround;
    [UsedImplicitly] public double SpeedWander;
    [UsedImplicitly] public double SpeedApproach;
    [UsedImplicitly] public double SpeedWanderNight;
    [UsedImplicitly] public double SpeedApproachNight;
    [UsedImplicitly] public double SpeedPanic;
    [UsedImplicitly] public bool CanClimbVertical;
    [UsedImplicitly] public bool CanClimbLadders;
    [UsedImplicitly] public double AttackTimeoutDay;
    [UsedImplicitly] public double AttackTimeoutNight;

    [NotNull] [UsedImplicitly] public List<BCMDynamicProp> AITasks = new List<BCMDynamicProp>();
    [NotNull] [UsedImplicitly] public List<BCMDynamicProp> AITargetTasks = new List<BCMDynamicProp>();
    [UsedImplicitly] public BCMExplosionData Explosion;
    #endregion;
