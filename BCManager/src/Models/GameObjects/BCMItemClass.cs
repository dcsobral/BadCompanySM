...
namespace BCM.Models
{
  ...
  public class BCMItemClass : BCMAbstract
  {
    ...
    [UsedImplicitly] public bool IsBlock;
    [UsedImplicitly] public string Material;
    [UsedImplicitly] public int StackNumber;
    [UsedImplicitly] public string Icon;
    [UsedImplicitly] public string IconTint;
    ...
    private void GetIconTint(ItemClass item) => Bin.Add("IconTint", IconTint = item.GetIconTint().ToStringRgbHex(false));
