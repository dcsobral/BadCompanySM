...
namespace BCM.Models
{
  ...
  public class BCMPlayer : BCMAbstract
  {
    ...
    [UsedImplicitly] public string Ip;
    [UsedImplicitly] public string Ping;
    [UsedImplicitly] public double SessionPlayTime;
    [UsedImplicitly] public double TotalPlayTime;
    [UsedImplicitly] public string LastOnline;
    [UsedImplicitly] public int Underground;
    [UsedImplicitly] public Vector3 Position;
    [UsedImplicitly] public Vector3 Rotation;

    //STATS
    [UsedImplicitly] public int Health;
    [UsedImplicitly] public int Stamina;
    [UsedImplicitly] public int Wellness;
    [UsedImplicitly] public int Food;
    [UsedImplicitly] public int Drink;
    [UsedImplicitly] public int CoreTemp;
    [UsedImplicitly] public double SpeedModifier;
    [UsedImplicitly] public double? LastZombieAttacked;

    [UsedImplicitly] public bool IsDead;
    [UsedImplicitly] public bool? OnGround;
    [UsedImplicitly] public bool? IsStuck;
    [UsedImplicitly] public bool? IsSafeZoneActive;

    [UsedImplicitly] public int Level;
    [UsedImplicitly] public double LevelProgress;
    [UsedImplicitly] public int ExpToNextLevel;
    [UsedImplicitly] public int ExpForNextLevel;
    [UsedImplicitly] public int? Gamestage;

    [UsedImplicitly] public int Score;
    [UsedImplicitly] public int KilledPlayers;
    [UsedImplicitly] public int KilledZombies;
    [UsedImplicitly] public int Deaths;

    [UsedImplicitly] public double DistanceWalked;
    [UsedImplicitly] public uint ItemsCrafted;
    [UsedImplicitly] public double CurrentLife;
    [UsedImplicitly] public double LongestLife;

    [UsedImplicitly] public string Archetype;
    [UsedImplicitly] public Vector3 DroppedPack;
    [UsedImplicitly] public Vector3 RentedVendor;
    [UsedImplicitly] public ulong RentedVendorExpire;
    [UsedImplicitly] public bool? Remote;

    //BAG
    [UsedImplicitly] public Dictionary<string, BCMItemStack> Bag;

    //BELT
    [UsedImplicitly] public Dictionary<string, BCMItemStack> Belt;
    [UsedImplicitly] public int SelectedSlot;
    ...
    public class BCMItemValue
    {
      ...
      [UsedImplicitly] public string UISlot;

      [UsedImplicitly] public List<BCMAttachment> Attachments;
      [UsedImplicitly] public List<BCMParts> Parts;
    }
    [UsedImplicitly] public Dictionary<string, BCMItemValue> Equipment;
    ...
    public class BCMBuff
    {
      ...
      [UsedImplicitly] public string Name;
      [UsedImplicitly] public bool Expired;
      [UsedImplicitly] public bool IsOverriden;
      [UsedImplicitly] public int InstigatorId;
      [UsedImplicitly] public double Duration;
      [UsedImplicitly] public double TimeFraction;
    }
    [UsedImplicitly] public List<BCMBuff> Buffs;
    ...
    public class BCMSkill
    {
      [UsedImplicitly] public string Name;
      [UsedImplicitly] public int Level;
      [UsedImplicitly] public double Percent;
    }
    [UsedImplicitly] public int SkillPoints;
    [UsedImplicitly] public List<BCMSkill> Skills;
    ...
    public class BCMCraftingQueue
    {
      ...
      [UsedImplicitly] public string Name;
      [UsedImplicitly] public int Count;
      [UsedImplicitly] public double TotalTime;
      [UsedImplicitly] public double CraftTime;
      [UsedImplicitly] public List<BCMIngredient> Ingredients;
    }
    [UsedImplicitly] public List<BCMCraftingQueue> CraftingQueue;

    //RECIPES
    [UsedImplicitly] public List<string> FavouriteRecipes;
    [UsedImplicitly] public List<string> UnlockedRecipes;
    ...
    public class BCMQuest
    {
      [UsedImplicitly] public string Name;
      [UsedImplicitly] public string Id;
      [UsedImplicitly] public string CurrentState;
    }
    [UsedImplicitly] public List<BCMQuest> Quests;

    //SPAWNPOINTS+WAYPOINTS+MARKER
    [UsedImplicitly] public List<Vector3> Spawnpoints;
    [UsedImplicitly] public List<BCMWaypoint> Waypoints;
    [UsedImplicitly] public Vector3 Marker;
    [UsedImplicitly] public List<string> Friends = new List<string>();
    [UsedImplicitly] public List<Vector3> LPBlocks = new List<Vector3>();

    [UsedImplicitly] public double? LastSaveSecs;
    #endregion;
    ...
    private void GetWaypoints(PlayerInfo pInfo)
    {
      ...
      {
        Waypoints.Add(new BCMWaypoint(waypoint));
      }
