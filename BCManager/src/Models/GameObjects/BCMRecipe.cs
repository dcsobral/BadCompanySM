...
namespace BCM.Models
{
  ...
  public class BCMRecipe : BCMAbstract
  {
    ...
    [UsedImplicitly] public int CraftExp;
    [UsedImplicitly] public string CraftArea;
    [UsedImplicitly] public double CraftTime;
    [UsedImplicitly] public int CraftTool;
    [UsedImplicitly] public string Tooltip;
    [UsedImplicitly] public bool IsMatBased;
    [UsedImplicitly] public bool IsScrappable;
    [UsedImplicitly] public bool IsWildCamp;
    [UsedImplicitly] public bool IsWildForge;
    [UsedImplicitly] public string Skill;
    [NotNull] [UsedImplicitly] public List<BCMIngredient> Ingredients = new List<BCMIngredient>();
    #endregion;
    ...
    private void GetIngredients(Recipe recipe)
    {
      ...
      {
        Ingredients.Add(new BCMIngredient(itemStack.itemValue.type, itemStack.count));
      }
