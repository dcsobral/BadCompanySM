...
namespace BCM.Models
{
  ...
  public class BCMSpawner : BCMAbstract
  {
    ...
    [UsedImplicitly] public bool Dynamic;
    [UsedImplicitly] public bool WrapDays;
    [UsedImplicitly] public bool ClampDays;
    [NotNull] [UsedImplicitly] public List<BCMSpawnerClass> Spawns = new List<BCMSpawnerClass>();
    #endregion;
